...
namespace FileCreateWorkerService
{
    public class Worker : BackgroundService
    {
        ...
        private async Task Consumer_Received(object sender, BasicDeliverEventArgs @event)
        {
            ...
            var baseUrl = "https://localhost:7194/api/files";
        ...
        {
            List<FileCreateWorkerService.Models.DimProduct> products;
            ...
            products.ForEach(x =>
            {
                table.Rows.Add(x.ProductKey, x.ProductAlternateKey, x.EnglishProductName, x.Color);
